            ...
            <div>
                <Row>
                    <Col span={12} align='middle'>
                        <img alt='' className={styles.card} style={{ width: 450, height: 350 }} src={this.props.imageUrl} />
                    </Col>
                    <Col span={12}>
                        ...
                        <Row style={{ height: 50 }} type="flex" justify="space-around" align="middle">
                            ...
                            <Col span={18}><h1 style={{ color: 'blue', display: 'inline' }}>{this.props.price} </h1>&nbsp;&nbsp;元</Col>
                        </Row>
                        <Row style={{ height: 50 }} type="flex" justify="space-around" align="middle">
                            <Col span={6} align='middle'>库存</Col>
                            <Col span={18} ><h1 style={{ color: 'red', display: 'inline' }} >{this.props.maxNum}</h1>&nbsp;&nbsp;个</Col>
                        </Row>
                        <Row style={{ height: 50 }} type="flex" justify="space-around" align="middle">
                        ...
                        <Row style={{ height: 50 }} type="flex" justify="space-around" align="middle">
                            ...
                            <Col span={18} >
                                <InputNumber min={1} max={this.props.maxNum} defaultValue={1} onChange={(value) => this.onChange(value)} />,
                            </Col>
                        </Row>
                        <Row style={{ height: 50 }} type="flex" justify="space-around" align="middle">
                            <Col span={6} ></Col>
